...
class TempoEpisodio implements Comparator<Serie>{

	@Override
	public int compare(Serie serieTempo, Serie serieEpisodio) {
		
		return serieTempo.getTempoEpisodio().compareTo(serieEpisodio.getTempoEpisodio());
	}
